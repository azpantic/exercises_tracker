...
///
/// Built on 2023-04-22 at 09:56 UTC
...
class _StringsCalendarEn {
	...
	// Translations
	String get add_workout => 'Add workout';
}
...
class _StringsCalendarRu implements _StringsCalendarEn {
	...
	// Translations
	@override String get add_workout => 'Добавить тренировку';
}
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'calendar.add_workout': return 'Add workout';
			case 'navbar.calendar': return 'Calendar';
			case 'navbar.list': return 'List';
			case 'navbar.settings': return 'Settigns';
			case 'settings.title': return 'Theme settings';
...
extension on _StringsRu {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'calendar.add_workout': return 'Добавить тренировку';
			case 'navbar.calendar': return 'Календарь';
			case 'navbar.list': return 'Список';
			case 'navbar.settings': return 'Настройки';
			case 'settings.title': return 'Настройки темы';
